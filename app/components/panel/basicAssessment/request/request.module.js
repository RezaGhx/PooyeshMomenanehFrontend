const requestModule = angular.module("panel.basicAssessment.requestModule", []);
...
controllers.keys().map(function(value) {
  require(`./controllers/${value.slice(2)}`)(requestModule);
});
...
try {
  ...
  factories.keys().map(function(value) {
    try {
      require(`./factories/${value.slice(2)}`)(requestModule);
    } catch (error) {}
  });
} catch (error) {}
...
try {
  ...
  filters.keys().map(function(value) {
    try {
      require(`./filters/${value.slice(2)}`)(requestModule);
    } catch (error) {}
  });
} catch (error) {}
...
services.keys().map(function(value) {
  require(`./services/${value.slice(2)}`)(requestModule);
});
