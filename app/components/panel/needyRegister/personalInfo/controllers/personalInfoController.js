personalInfoController.$inject = ["panel.needyRegister.personalInfoServices", "Upload", "$state"];
    ...
    if (form.$valid) {
      ...
      personalInfoServices.create(parameter, ticket).$promise.then(
        response => {
          ...
          state.go("panel.needyRegister.list");
        },
        errResponse => {
          iziToast.show({
...
module.exports = ngModule => {
  ngModule.controller("panel.needyRegister.personalInfoController", personalInfoController);
};
