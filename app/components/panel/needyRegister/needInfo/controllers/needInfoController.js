needInfoController.$inject = ["panel.needyRegister.needInfoServices", "Upload", "$state"];
...
module.exports = ngModule => {
  ngModule.controller("panel.needyRegister.needInfoController", needInfoController);
};
