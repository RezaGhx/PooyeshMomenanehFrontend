...
(function (angular) {
    ...
    var ADMdtpFactory = function (ADMdtpConvertor) {
        ...
        this.validateJalaliDate = function (input, format) {
            ...
            if (typeof input == "number") {
                ...
                _dateTime = angular.merge(_pDate, {
                    hour: _gDate.getHours(),
                    minute: _gDate.getMinutes()
                });
        ...
        this.convertToJalali = function (date) {
            ...
            if (date instanceof Object) {
                return angular.merge(ADMdtpConvertor.toJalali(date.year, date.month, date.day), {
                    unix: date.unix
                });
            }
        };
    ...
    var ADMdtpDirective = function (ADMdtp, ADMdtpConvertor, ADMdtpFactory, constants, $compile, $timeout) {
        ...
        return {
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                var distroyremovehidden = function () {
                    scope.destroy();
                    scope.closeCalendar();
                }
                dtpDestroy.onclick = distroyremovehidden;
    ...
    var ADMdtpConfig = function (ADMdtp) {
        ...
        ADMdtp.setOptions({
            isDeviceTouch: ('ontouchstart' in window || navigator.maxTouchPoints)
        });
